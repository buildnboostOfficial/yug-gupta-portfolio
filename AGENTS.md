# AI Agent Guidelines for yuggupta.com

This guide provides essential information for AI agents working with the yuggupta.com codebase - a Next.js dev portfolio, blog, and component registry website.

## Project Overview

**yuggupta.com** is a minimal, pixel-perfect dev portfolio, component registry, and blog built with modern web technologies. It serves as:

- Personal portfolio for Yug Gupta (@yuggupta)
